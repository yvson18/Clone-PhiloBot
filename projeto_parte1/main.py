...
fundo = Image.open("projeto_parte1/imgs_req/fundo_preto.jpg")
...
font1 = ImageFont.truetype("projeto_parte1/fonts/arial_narrow_7.ttf",50)
font2 = ImageFont.truetype("projeto_parte1/fonts/arial_narrow_7.ttf",30)
...
autor_image = Image.open("projeto_parte1/image_data/Leo_Stronda.jpg")
autor_image_newsize = autor_image.resize((428,584)) #Redmensionar para encaixar


parte_branca = Image.open("projeto_parte1/imgs_req/parte_branca_650_x_584.jpg")

imagem_concatenada = get_concat_h(parte_branca,autor_image_newsize)

mask = Image.open("projeto_parte1/imgs_req/gradiente.jpg").convert("L")

img_final = Image.composite(imagem_concatenada,fundo_mod,mask)

img_final.save("projeto_parte1/img_output/Imagem-Retornada-1.jpg")
